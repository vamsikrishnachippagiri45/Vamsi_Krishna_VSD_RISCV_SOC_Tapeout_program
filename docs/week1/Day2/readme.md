...
In Yosys, after you synthesize RTL → you have generic flip-flops (like $dff, $adff, $sdff, etc.).
These are abstract DFF primitives (not tied to any silicon cell yet).
dfflibmap replaces these abstract DFFs with real technology-specific flip-flops available in your .lib file.
```
