...
| --------------------------------------------------- | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| **Setup Time (T<sub>setup</sub>)**                  | Minimum time before the **clock edge** that data must be stable at the flip-flop input. | If violated → **Setup violation**, data not captured correctly.        | T<sub>cq</sub> + T<sub>comb</sub> + T<sub>setup</sub> ≤ T<sub>clk</sub> + T<sub>skew</sub> − T<sub>jitter</sub> | Reduces **maximum clock frequency**; affects performance.     |
