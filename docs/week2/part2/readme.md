...
3. [RVMYTH Core Simulation Methods](#rvmyth-core-simulation-methods)
    - [(i) Convert TLV File to verilog/system verilog](#i-convert-tlv-file-to-verilogsystem-verilog)
    - [(ii) Stub Method (Used Here)](#ii-stub-method-used-here)
        - [rvmyth_stub Module](#rvmyth_stub-module)
4. [Presynthsis simulation](#presynthsis-simulation)
    - [1. Compilation (iverilog)](#1-compilation-iverilog)
    - [2. Simulation Execution (./pre_synth_sim.out)](#2-simulation-execution-pre_synth_simout)
    - [3. Waveform Analysis (gtkwave)](#3-waveform-analysis-gtkwave)
5. [Observations in GTKWave](#observations-in-gtkwave)
    - [Core (RVMYTH Stub) verification](#core-rvmyth-stub-verification)
        - [Reset and Initialization](#reset-and-initialization)
        - [Clocking and Data Generation](#clocking-and-data-generation)
    - [PLL (Clocking) verification](#pll-clocking-verification)
    - [DAC verification](#dac-verification)
    - [VSDBabySoC Verification](#vsdbabysoc-verification)
6. [Summary](#summary)
